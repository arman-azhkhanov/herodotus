#+title: Herodotus project tech specification
...
-----
***** 2. Handling of Missing or Non-standard Attributes
...
-----
***** 3. Handling of Cycles and Complex Graph Structures
...
-----
***** 4. Height Calculation Requirements
...
****** Calculation Rules
   - *Initial Version*: For the initial implementation, all nodes will have a *fixed height*. This simplifies vertical offset calculations.
     - ~height~ = `(NODE_PADDING_VERTICAL * 2) + (single-line-text-height)`. For example, `(15 * 2) + 20 = 50px`.
